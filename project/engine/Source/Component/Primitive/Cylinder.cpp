...
Cylinder CylinderGenerator::CreateCylinder(uint32_t divide, float topRadius, float bottomRadius, float height, const std::string &textureFileName) {
	Cylinder cylinder{
		.meshHandle = meshManager_->CreateCylinder(divide, topRadius, bottomRadius, height),	// メッシュハンドル
