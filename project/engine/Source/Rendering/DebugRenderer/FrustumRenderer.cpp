...
#ifdef DRAW_LINE
	registry_->ForEach<Camera, QuaternionTransform, MainCamera, FrustumRenderer>([&](uint32_t entity, Camera *camera, QuaternionTransform *transform, MainCamera *cullingCamera, FrustumRenderer *frustumRenderer) {
		// ビュー行列とプロジェクション行列の計算
